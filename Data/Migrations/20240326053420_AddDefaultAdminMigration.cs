        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardTransactionNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodPackage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodPackage_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodPackage_Package_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderTakenById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OrderedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_AspNetUsers_OrderTakenById",
                        column: x => x.OrderTakenById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItem_FoodPackage_FoodPackageId",
                        column: x => x.FoodPackageId,
                        principalTable: "FoodPackage",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "DOB", "Email", "EmailConfirmed", "FatherName", "FirstName", "FullName", "GenderId", "Image", "LastName", "LockoutEnabled", "LockoutEnd", "MiddleName", "MotherName", "NID", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "SpouseName", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("165d85b8-c45b-4fdf-b812-eb27e9e67264"), 0, "c0546a67-12e3-413e-98d7-2e981f03aa95", new DateTime(1993, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@mail.com", false, "", "System", "Admin", 1, "", "", false, null, "Admin", "", "", "admin@mail.com", "admin@mail.com", "AQAAAAEAACcQAAAAEFTw0YzFmNSap0Oq8Tb4C2h1Jdvd1fMHL+pKDwaxcY+2Rg/i3jP0cAKJshnm6wy/fQ==", "01956431180", false, "KOFABGFNZCSAIOQ7VCPER53GEIMMBIFK", "", false, "admin@mail.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTable_EmployeeId",
                table: "EmployeeTable",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodPackage_FoodId",
                table: "FoodPackage",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodPackage_PackageId",
                table: "FoodPackage",
                column: "PackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItem_FoodPackageId",
                table: "OrderItem",
